    ...
    <div>
      ...
      >
        ...
        >
          ...
          <p className="text-sm text-gray-600 dark:text-[#ffff00] dark:font-medium">
        ...
        <motion.div
          ...
          className="p-6 bg-[#F1E8DF] dark:bg-black rounded-2xl dark:rounded-none border border-[#A9C8DA] dark:border-[#ff0000] text-center hover:shadow-lg dark:hover:shadow-[#ff0000] transition-all duration-300 dark:animate-pulse"
        >
          <div className="w-12 h-12 bg-[#E57986] dark:bg-[#00ff00] rounded-full dark:rounded-none flex items-center justify-center mx-auto mb-4 dark:animate-pulse">
            <span className="text-white dark:text-black font-bold dark:font-extrabold text-lg">
              {Filters - 1}
            </span>
          </div>
        ...
        <motion.div
          ...
          className="p-6 bg-[#F1E8DF] dark:bg-black rounded-2xl dark:rounded-none border border-[#A9C8DA] dark:border-[#ff0000] text-center hover:shadow-lg dark:hover:shadow-[#ff0000] transition-all duration-300 dark:animate-pulse"
        >
          <div className="w-12 h-12 bg-[#A45F7B] dark:bg-[#00ff00] rounded-full dark:rounded-none flex items-center justify-center mx-auto mb-4 dark:animate-puls">
